...
## 🔍 Validador de Opções B3 — validate_options_b3.py
...
3. 🔴 **P(ITM) incorreto** (probabilidade real)
4. 🔴 **Theta positivo** (impossível para long call)
5. 🔴 **Break-even errado** (Strike + Premium)
6. 🟡 **Classificação ATM/OTM/ITM**
7. 🟡 **P&L calculado**
8. 🟡 **Kelly Criterion**
...
```bash
# COGN3
python3 scripts/validate_options_b3.py COGN3 2.97 3.35 23 0.1475 0.65 COGNE335 2026-04-24 0.085 3.80 10
